...
HRESULT vdecl_convert_fvf(
    ...
    elements = malloc(size * sizeof(D3DVERTEXELEMENT9));
        ...
        struct wined3d_vertex_element **wined3d_elements, UINT *element_count)
{
    ...
    *wined3d_elements = malloc(count * sizeof(**wined3d_elements));
    if (!*wined3d_elements) {
        ...
        struct d3d9_device *device, const D3DVERTEXELEMENT9 *elements)
{
    ...
    declaration->elements = malloc(element_count * sizeof(*declaration->elements));
