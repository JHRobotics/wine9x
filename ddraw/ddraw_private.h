...
DWORD get_flexible_vertex_size_ddraw(DWORD d3dvtVertexType) DECLSPEC_HIDDEN;
...
void multiply_matrix_ddraw(D3DMATRIX *dst, const D3DMATRIX *src1, const D3DMATRIX *src2) DECLSPEC_HIDDEN;
...
/* if we using call loop detection, we cannot call public interfaces of functions, here are private versions: */
HRESULT DirectDrawCreateClipper_internal(DWORD flags, IDirectDrawClipper **clipper, IUnknown *outer_unknown);
