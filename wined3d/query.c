        ...
        enum wined3d_query_type type, void *parent)
{
    ...
    switch (type)
    {
        case WINED3D_QUERY_TYPE_OCCLUSION:
            ...
            query->extendedData = malloc( sizeof(struct wined3d_occlusion_query));
        ...
        case WINED3D_QUERY_TYPE_EVENT:
            ...
            query->extendedData = calloc(1, sizeof(struct wined3d_event_query));
            if (!query->extendedData)
            {
        ...
        case WINED3D_QUERY_TYPE_TIMESTAMP:
            ...
            query->extendedData = malloc( sizeof(struct wined3d_timestamp_query));
            if (!query->extendedData)
            {
